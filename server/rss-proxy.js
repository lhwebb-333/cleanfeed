...
const SOURCES = {
  reuters: {
    ...
    feeds: [
      ...
      { url: "https://news.google.com/rss/search?q=when:24h+allinurl:reuters.com/sports&ceid=US:en&hl=en-US&gl=US", category: "sports" },
    ],
    color: "#FF8C00",
  },
  ap: {
    ...
    feeds: [
      ...
      { url: "https://news.google.com/rss/search?q=when:24h+allinurl:apnews.com/sports&ceid=US:en&hl=en-US&gl=US", category: "sports" },
      { url: "https://news.google.com/rss/search?q=when:24h+allinurl:apnews.com/hub/nfl+OR+allinurl:apnews.com/hub/nba+OR+allinurl:apnews.com/hub/mlb+OR+allinurl:apnews.com/hub/nhl&ceid=US:en&hl=en-US&gl=US", category: "sports" },
      { url: "https://news.google.com/rss/search?q=when:24h+allinurl:apnews.com/business&ceid=US:en&hl=en-US&gl=US", category: "financial" },
      { url: "https://news.google.com/rss/search?q=when:24h+allinurl:apnews.com/technology&ceid=US:en&hl=en-US&gl=US", category: "tech" },
      { url: "https://news.google.com/rss/search?q=when:24h+allinurl:apnews.com/science&ceid=US:en&hl=en-US&gl=US", category: "science" },
      { url: "https://news.google.com/rss/search?q=when:24h+allinurl:apnews.com/health&ceid=US:en&hl=en-US&gl=US", category: "health" },
    ],
    color: "#4A90D9",
  },
  bbc: {
